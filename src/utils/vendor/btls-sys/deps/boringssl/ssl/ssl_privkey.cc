...
static const SSL_SIGNATURE_ALGORITHM kSignatureAlgorithms[] = {
    ...
    // ML-DSA code points (0x0904/0x0905/0x0906). These are advertise-only
    // entries so the client can list them in the ClientHello
    // signature_algorithms extension to match Chrome. pkey_type is
    // EVP_PKEY_NONE so |ssl_pkey_supports_algorithm| never selects them for
    // real signing or verification.
    {0x0904, EVP_PKEY_NONE, NID_undef, nullptr,
     /*is_rsa_pss=*/false, /*tls12_ok=*/false, /*tls13_ok=*/true,
     /*client_only=*/true},
    {0x0905, EVP_PKEY_NONE, NID_undef, nullptr,
     /*is_rsa_pss=*/false, /*tls12_ok=*/false, /*tls13_ok=*/true,
     /*client_only=*/true},
    {0x0906, EVP_PKEY_NONE, NID_undef, nullptr,
     /*is_rsa_pss=*/false, /*tls12_ok=*/false, /*tls13_ok=*/true,
     /*client_only=*/true},
};
...
static const SignatureAlgorithmName kSignatureAlgorithmNames[] = {
    ...
    // Advertise-only ML-DSA names mapping to code points 0x0904/0x0905/0x0906.
    {0x0904, "mldsa44"},
    {0x0905, "mldsa65"},
    {0x0906, "mldsa87"},
};
